package com.example.springbootweek08.scan;
...
public class QrSignService {
    ...
    /**
     * 生成签到码 + 生成二维码base64（页面直接展示）
     *
     * @param activityId 活动/班级ID
     * @return base64二维码 + 签到码
     */
    public String generateQrCode(String activityId) {
        ...
        String scanUrl = "http://172.20.10.2:8080/sign/scan?code=" + signCode;
